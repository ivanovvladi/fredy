...
class FredyRuntime {
  ...
  _getListings(url) {
    return new Promise((resolve, reject) => {
      ...
      if (scrapingAnt.needScrapingProvider(id) && !scrapingAnt.isScrapingAntApiKeySet()) {
      ...
      const xray = new Scraper(id).x;
      try {
        if (this._providerConfig.paginate != null) {
          xray(url, this._providerConfig.crawlContainer, [this._providerConfig.crawlFields])
